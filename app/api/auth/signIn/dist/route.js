...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, User, user, isMatch, token, response, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    isMatch = _b.sent();
                    if (!isMatch) {
                        return [2 /*return*/, server_1.NextResponse.json({ message: "Wrong password" }, { status: 401 })];
                    }
                    ...
                    }, process.env.JWT_WEB_TOKEN, { expiresIn: "7d" });
