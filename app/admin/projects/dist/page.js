...
function ProjectsListPage() {
    ...
    useProtectedRoute_1.useProtectedRoute(setUser, { homeAdmin: true, setProjects: setProjects, setRisks: setRisks, setFeedbacks: setFeedbacks, setCheckIns: setCheckIns }, "admin", setIsLoading);
    if (isLoading)
    ...
    return (React.createElement("div", { className: "p-4" },
        React.createElement("div", { className: "flex items-center justify-between mb-12" },
            React.createElement("div", null,
                ...
                React.createElement("p", { className: "text-gray-600 text-lg" }, "Manage and monitor all your active projects")),
            React.createElement(link_1["default"], { href: "/admin/projects/new" },
                React.createElement(components_1.Button, { size: "lg", className: "bg-blue-600 hover:bg-blue-700 shadow-md transition-all" }, "+ New Project"))),
