        ...
        projects.length === 0 ? (React.createElement(components_1.Card, { className: "rounded-xl border border-gray-200 shadow-sm" },
            ...
            React.createElement("div", { className: "space-y-3" }, projects.map(function (project) { return (React.createElement("div", { key: project._id },
                React.createElement(link_1["default"], { key: project._id, href: {
                    ...
                    React.createElement(components_1.Card, { className: "hover:shadow-md transition-shadow cursor-pointer rounded-xl border border-gray-200" },
                        React.createElement(components_1.CardBody, { className: "p-4" },
                            React.createElement("div", { className: "flex items-center justify-between" },
                                React.createElement("div", null,
                                    React.createElement("h3", { className: "font-semibold text-gray-900" }, project.name),
                                    React.createElement("p", { className: "text-sm text-gray-600 line-clamp-1" }, project.description)),
                                React.createElement(components_1.Button, { size: "sm", className: "bg-blue-600 text-white hover:bg-blue-700" }, "New Feedback"))))),
